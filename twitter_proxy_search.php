...
class TwitterProxy_search {
	...
	public function __construct($oauth_access_token, $oauth_access_token_secret, $consumer_key, $consumer_secret, $q) {
		...
		$this->config = array_merge($this->config, compact('oauth_access_token', 'oauth_access_token_secret', 'consumer_key', 'consumer_secret', 'q'));
		...
		$this->whitelist['search/tweets.json?q=' . $this->config['q'] ] = true;
